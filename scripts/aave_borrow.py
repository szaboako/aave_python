...
def main():
    ...
    # borrowable_eth -> borrowable_dai * 95%(for safety we can lower the percentage)
...
def get_borrowable_data(lending_pool, account):
    ...
    print(f"You have crypto thats worth {total_collateral_eth} Ethereum deposited")
    print(f"You can borrow crypto thats value doesn't exceed {available_borrow_eth} Ethereum")
    print(f"Your total depth is {total_dept_eth} in Ethereum")
